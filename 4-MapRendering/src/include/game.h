...
int verifyMap(int wid, int heig, int map[][wid], char *);
int createNewMap(int wid, int heig, int map[][wid], char *);
void createRects(SDL_Rect *, int wid, int heig, int map[][wid]);
void renderRects(SDL_Rect *, int);
